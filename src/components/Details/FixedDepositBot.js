    ...
    <ChatBot
      ...
      steps={[
        ...
        },
        {
          id: "5",
          message:
            "I forgot to tell you that I will grant you one wish but you have to prove you are worthy",
          trigger: "6",
        },
        {
          id: "6",
          message:
            "We will go through the next one year of your life in next five minutes",
          trigger: "7",
        },
        {
          id: "7",
        ...
        },
        {
          ...
          options: [
            ...
            {
              value: "Walk Away from Genie",
              label: "Walk Away from Genie",
              trigger: "10",
            },
          ],
        },
        ...
        },
        {
          id: "11",
          message:
            "Alpha Inc has recorded $250 million in first quarter of the year",
          trigger: "12",
        },
        {
          id: "12",
          message:
            "Beta Inc got Series C funding and now is valued at $7billion dollars",
          trigger: "13",
        },
        {
          id: "13",
          message:
            "Zeta India, which was voted the most loved company in India",
          trigger: "14",
        },
        {
          id: "14",
        ...
        },
        {
          id: "16",
          message:
            "You can get a personal loan to pay up for your future contracts",
          trigger: "17",
        },
        {
          id: "17",
        ...
        },
        {
          id: "18",
          message:
            "Or You have sell seven cars in your collection for about 6 crores to settle the payment",
          trigger: "reduction",
        },

        {
          ...
          options: [
            ...
            {
              value: "Sell Seven Cars",
              label: "Sell Seven Cars",
              trigger: "20",
            },
          ],
        },
        ...
        },
        {
          id: "22",
          message:
            "Given your financial situation, you need a portfolio with less risk",
          trigger: "23",
        },
        {
          id: "23",
