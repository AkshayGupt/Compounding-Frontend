...
const LandingScreen = () => {
  ...
  useEffect(() => {
    if (
      ...
      JSON.parse(localStorage.getItem("data")).user != null
    ) {
      setSuccess(true);
    }
  }, []);
  ...
  const images = [
    {
      ...
      color: "#6a0dad",
      text: `Work towards financial freedom`,
    },
    {
      src: "/images/avatars/Avatar2_noob_girl.png",
      color: "#00ccff",
      text: "Set goals with friends and family",
    },
    {
      src: "/images/avatars/Avatar3_Noob.png",
      color: "#ff6666",
      text: "Earn rewards from popular brands",
    },
  ];
